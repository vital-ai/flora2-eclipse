...
import ai.vital.flora2.edit.flora2Editor.Flora2EditorFactory;
 ...
 * @generated
 */
public class Flora2EditorPackageImpl extends EPackageImpl implements Flora2EditorPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see ai.vital.flora2.edit.flora2Editor.Flora2EditorPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private Flora2EditorPackageImpl()
  {
    super(eNS_URI, Flora2EditorFactory.eINSTANCE);
  }
   ...
   *
   * <p>This method is used to initialize {@link Flora2EditorPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static Flora2EditorPackage init()
  {
    if (isInited) return (Flora2EditorPackage)EPackage.Registry.INSTANCE.getEPackage(Flora2EditorPackage.eNS_URI);

    // Obtain or create and register package
    Object registeredFlora2EditorPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
    Flora2EditorPackageImpl theFlora2EditorPackage = registeredFlora2EditorPackage instanceof Flora2EditorPackageImpl ? (Flora2EditorPackageImpl)registeredFlora2EditorPackage : new Flora2EditorPackageImpl();

    isInited = true;

    // Create package meta-data objects
    theFlora2EditorPackage.createPackageContents();

    // Initialize created meta-data
    theFlora2EditorPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theFlora2EditorPackage.freeze();

    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(Flora2EditorPackage.eNS_URI, theFlora2EditorPackage);
    return theFlora2EditorPackage;
  }
   ...
   * @generated
   */
  public Flora2EditorFactory getFlora2EditorFactory()
  {
    return (Flora2EditorFactory)getEFactoryInstance();
  }
