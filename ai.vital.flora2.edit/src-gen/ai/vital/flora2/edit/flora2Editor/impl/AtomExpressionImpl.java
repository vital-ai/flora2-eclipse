 ...
 * </p>
 * <ul>
 *   <li>{@link ai.vital.flora2.edit.flora2Editor.impl.AtomExpressionImpl#getAtom <em>Atom</em>}</li>
 *   <li>{@link ai.vital.flora2.edit.flora2Editor.impl.AtomExpressionImpl#getTerms <em>Terms</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AtomExpressionImpl extends ExpressionImpl implements AtomExpression
{
  ...
  {
    return Flora2EditorPackage.Literals.ATOM_EXPRESSION;
  }
  ...
  public void setAtom(String newAtom)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Flora2EditorPackage.ATOM_EXPRESSION__ATOM, oldAtom, atom));
  }
  ...
  public NotificationChain basicSetTerms(Expression newTerms, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Flora2EditorPackage.ATOM_EXPRESSION__TERMS, oldTerms, newTerms);
  ...
  public void setTerms(Expression newTerms)
  {
    if (newTerms != terms)
    {
      ...
      if (terms != null)
        msgs = ((InternalEObject)terms).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Flora2EditorPackage.ATOM_EXPRESSION__TERMS, null, msgs);
      if (newTerms != null)
        msgs = ((InternalEObject)newTerms).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Flora2EditorPackage.ATOM_EXPRESSION__TERMS, null, msgs);
      msgs = basicSetTerms(newTerms, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Flora2EditorPackage.ATOM_EXPRESSION__TERMS, newTerms, newTerms));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case Flora2EditorPackage.ATOM_EXPRESSION__TERMS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case Flora2EditorPackage.ATOM_EXPRESSION__ATOM:
        return getAtom();
      case Flora2EditorPackage.ATOM_EXPRESSION__TERMS:
        return getTerms();
    }
