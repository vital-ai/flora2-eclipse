package ai.vital.flora2.edit.serializer;
...
import ai.vital.flora2.edit.flora2Editor.StringExpression;
import ai.vital.flora2.edit.flora2Editor.UnaryExpression;
import ai.vital.flora2.edit.flora2Editor.VariableExpression;
...
public class Flora2EditorSemanticSequencer extends AbstractDelegatingSemanticSequencer {

	@Inject
	private Flora2EditorGrammarAccess grammarAccess;
	
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == Flora2EditorPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			case Flora2EditorPackage.ATOM_EXPRESSION:
			...
			case Flora2EditorPackage.EXPRESSION:
			...
			case Flora2EditorPackage.LIST_EXPRESSION:
				if(context == grammarAccess.getExpression0Rule() ||
				   context == grammarAccess.getExpression200xfxRule() ||
				   context == grammarAccess.getExpression200xfxAccess().getExpressionLeftAction_1_0() ||
				   context == grammarAccess.getExpression200xfyRule() ||
			...
			case Flora2EditorPackage.MODEL:
				if(context == grammarAccess.getModelRule()) {
					sequence_Model(context, (Model) semanticObject); 
					return; 
				}
				else break;
			case Flora2EditorPackage.NUMBER_EXPRESSION:
				if(context == grammarAccess.getExpression0Rule() ||
				   context == grammarAccess.getExpression200xfxRule() ||
				   context == grammarAccess.getExpression200xfxAccess().getExpressionLeftAction_1_0() ||
				   context == grammarAccess.getExpression200xfyRule() ||
			...
			case Flora2EditorPackage.STRING_EXPRESSION:
				if(context == grammarAccess.getExpression0Rule() ||
				   context == grammarAccess.getExpression200xfxRule() ||
				   context == grammarAccess.getExpression200xfxAccess().getExpressionLeftAction_1_0() ||
				   context == grammarAccess.getExpression200xfyRule() ||
			...
			case Flora2EditorPackage.UNARY_EXPRESSION:
			...
			case Flora2EditorPackage.VARIABLE_EXPRESSION:
				if(context == grammarAccess.getExpression0Rule() ||
				   context == grammarAccess.getExpression200xfxRule() ||
				   context == grammarAccess.getExpression200xfxAccess().getExpressionLeftAction_1_0() ||
				   context == grammarAccess.getExpression200xfyRule() ||
	...
	protected void sequence_Expression1200xfx(EObject context, Expression semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, Flora2EditorPackage.Literals.EXPRESSION__LEFT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, Flora2EditorPackage.Literals.EXPRESSION__LEFT));
			if(transientValues.isValueTransient(semanticObject, Flora2EditorPackage.Literals.EXPRESSION__OP) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, Flora2EditorPackage.Literals.EXPRESSION__OP));
			if(transientValues.isValueTransient(semanticObject, Flora2EditorPackage.Literals.EXPRESSION__RIGHT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, Flora2EditorPackage.Literals.EXPRESSION__RIGHT));
		}
